# pass - Kinesis Video Stream storage config with CMK
...
# fail - Kinesis Video Stream storage config without encryption
...
# pass - Not a Kinesis Video Stream storage config (not applicable)
